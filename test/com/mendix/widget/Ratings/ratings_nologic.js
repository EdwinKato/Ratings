define([
    ...
    return declare("com.mendix.widget.Ratings.ratings_nologic", [ _WidgetBase, _TemplatedMixin ], {
        ...
        postCreate : function(){
            ...
            for (var i = 1; i <= this.maxCounter; i++) {
        ...
        displayImages : function (iterator) {
            ...
            if (iterator < 0 || iterator > this.maxCounter) {
                return;
            }
            ...
            for (var x = 4; x > iterator-1; x--) {
                domAttr.set(this.mouseoverArray[x].element, "src", this._getImagePath(this.standardImage));
            }
        },
